...
let example2Second = [19, 8, -93, 4, 1, 16, 77, 780, 43, 237, 56];    
    ...
    //- берет элемент который мы сравнивать будем с остальными элементами цикл
        ...
        //он перебирает весь наш массив начиная с индекса, который сейчас проходит по первому циклу
         ...
         if (min != i) {//после прохождения всего цикла мы смотрим, если минимальное НЕ равно индексу который взят из первого цикла
             let x = example2Second[i];//то создаем переменную в которую записываем значение элемента которое в массиве под индексом что проходит по первому циклу 
        ...
        //который находится в массиве под индексом, что записано в минимальное значение
             example2Second[min] = x; //и что элемент под индексом, который минмальный присваиваем значение которое было под индексом взятым из первого цикла

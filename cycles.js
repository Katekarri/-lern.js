...
let num;
    do {  //выполнять тело цикла
      num = prompt("Введите число больше 100?"); //а именно вывод  prompt и запрос ввести число
    } while (num <= 100 && num === null);</script> //пока num меньше ли равно 100 и пока num  равно null
